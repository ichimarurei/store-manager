...
const ItemForm = ({ mode, record, list, addToCart, getProducts }: { mode: 'add' | 'edit'; record: SalesDocument | undefined | null; list: ProductDocument[]; addToCart: (value: any) => void; getProducts: () => Promise<void> }) => {
    ...
    return (
        <div className="card">
            ...
            <p>Pemilihan daftar barang keluar {mode === 'edit' && <mark>{record?.reference}</mark>}</p>
